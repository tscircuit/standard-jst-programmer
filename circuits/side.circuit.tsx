...
export default (props: BoardProps = {}) => <board {...props} width={20} height={23}>
  <StandardJstSwdSide name="J1" pcbX={-4.5} pcbY={4} pcbStyle={{silkscreenTextVisibility:"hidden"}} />
  <StandardJstPowerSide name="J2" pcbX={4.5} pcbY={4} pcbStyle={{silkscreenTextVisibility:"hidden"}} />
  ...
  <StandardJstSwdResetSide name="J3" pcbX={0} pcbY={-6} pcbStyle={{silkscreenTextVisibility:"hidden"}} />
